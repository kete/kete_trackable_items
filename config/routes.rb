...
ActionController::Routing::Routes.draw do |map|
  ...
  map.resources :trackable_item_shelf_locations, :path_prefix => ':urlified_name', :only => [:new, :create, :update], :collection => {:bulk_export => [:get], :bulk_import => [:get, :post], :generate_export => [:post, :get]}
